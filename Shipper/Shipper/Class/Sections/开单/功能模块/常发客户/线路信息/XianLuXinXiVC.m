...
@interface XianLuXinXiVC ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,strong) CJTableView *tableView;
@property (nonatomic,strong) UITextField *tfSearch;

@end

@implementation XianLuXinXiVC

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    [self setTitleName:@"线路信息"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    static NSString *identifier = @"XianLuXinXiCell";
    XianLuXinXiCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        cell = [[XianLuXinXiCell alloc] initWithFlex:nil reuseIdentifier:identifier];
