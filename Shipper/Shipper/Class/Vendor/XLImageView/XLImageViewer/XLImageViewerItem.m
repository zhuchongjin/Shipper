...
//        _imageView.image = [UIImage imageWithContentsOfFile:imageUrl];
    ...
    //显示网络图片
    [_imageView sd_setImageWithURL:[NSURL URLWithString:imageUrl] placeholderImage:[UIImage imageNamed:@"zcj_error_image"] options:SDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
